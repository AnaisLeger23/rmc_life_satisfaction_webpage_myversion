...
author: "ANaïs Léger" # Remember to add your name!
theme: united
---
...
### Happiness across the world over time {.tabset}
...
countries_chart <- c("Afghanistan", "China", "Congo", "Costa Rica")
